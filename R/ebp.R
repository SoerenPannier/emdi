...
#' applications, a modified approach, census EBP by ..., is implemented for the 
#' point estimation. For the MSE estimation, the bootstrap sample is not extracted
#' from the superpopulation, but generated by the estimated model parameters. \cr \cr
#' The lower the ratio between the sample and the population size, the closer are 
#' the results to the proposed approach by Molina and Rao (2010).
#' @references
