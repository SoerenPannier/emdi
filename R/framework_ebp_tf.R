...
framework_ebp_tf <- function(fixed, pop_data, pop_domains, pop_subdomains,
  ...
  # Order of domains
  #pop_data$inter <- interaction(pop_data[[pop_domains]],
  ...
  pop_subdomains_vec <- factor(interaction(pop_data[[pop_domains]],
                                           pop_data[[pop_subdomains]]))
  ...
  smp_subdomains_vec <- factor(interaction(smp_data[[smp_domains]],
                                           smp_data[[smp_subdomains]]))
