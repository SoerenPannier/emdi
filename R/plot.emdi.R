...
#' plot(emdi_model)
#' 
#' # Creation of diagnostic plots without title
#' plot(emdi_model, label="no_title")
#' 
#' # Creation of diagnostic plots without labels and different colors
#' plot(emdi_model, label="blank", color=c("red", "yellow"))
#' 
#' @export
#' @method plot emdi
