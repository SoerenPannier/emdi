...
####################
# Code in Section 4.1 Estimation procedure for the standard 
# Fay-Herriot model 
####################
...
# EBLUP and MSE results (Showing the first 6 rows of the results with 
# head command)
...
## Export the results
# Export to excel (Note that under Windows RTools needs to be installed 
# or rather it is important to have a zip application (see also Details 
# in help(write.excel))
write.excel(fh_std, file = "fh_std_output.xlsx", MSE = TRUE, CV = TRUE)

####################
# Code in Section 4.2 Estimation of the extended area-level models 
####################
