...
update.packages("nlme", "moments", "ggplot2", "MuMIn", "gridExtra", "openxlsx",
                "reshape2", "graphics", "stats", "parallelMap", "HLMdiag",
                "parallel", "boot", "rgeos", "maptools", "MASS", "readODS",
                "testthat", "R.rsp", "simFrame", "laeken")